...
import { RootStackParamList, DishDetails } from './type';
...
export const HomeScreen: React.FC<HomeScreenProp> = (props) => {}

    const { average = { PriceAverage: 0 } } = props.route.params || {};

    const [Dish, setDishes] = useState<DishDetails[]>([]);
